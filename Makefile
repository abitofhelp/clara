# =============================================================================
# Clara Library Makefile
# =============================================================================
# Project: clara
# Purpose: Result, Option, Either for type-safe clara computation
#
...
help: ## Display this help message
	@echo "$(CYAN)$(BOLD)╔══════════════════════════════════════════════════╗$(NC)"
	@echo "$(CYAN)$(BOLD)║  Clara Library - Ada 2022                   ║$(NC)"
	@echo "$(CYAN)$(BOLD)╚══════════════════════════════════════════════════╝$(NC)"
	@echo " "
...
test-e2e: build build-tests
	...
	@echo "$(YELLOW)No E2E tests defined for clara library$(NC)"
...
stats:
	...
	@if [ -f "./lib/libclara.a" ]; then \
		echo "  Library: $$(ls -lh ./lib/libclara.a 2>/dev/null | awk '{print $$5}')"; \
	else \
