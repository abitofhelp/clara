...
The Clara library provides type-safe clara programming abstractions for Ada 2022. It enables railway-oriented programming with explicit error handling through Result, Option, Either, and Try types - eliminating the need for exceptions in business logic.
...
- [Software Requirements Specification](formal/software_requirements_specification.md) - Clara and non-clara requirements
...
package User_Result is new Clara.Result
